    ...
    <div className={`${isOpen ? 'w-64' : 'w-20'} flex flex-col border-r-1 border-gray-200 transition-all duration-300 bg-gray-100 text-gray-700 h-screen fixed z-10`}>
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <div className="space-y-1">
          <Link
            to="/"
            className={`flex items-center ${isOpen ? 'px-4 py-2 mx-2' : 'px-1 py-3 mx-2 justify-center'} rounded-sm transition-colors ${isActive('/') ? 'bg-blue-200 text-blue-700' : 'hover:bg-gray-200 text-gray-900'}`}
          >
            <FiHome className={`${isOpen ? 'mr-3' : ''} text-md`} />
          ...
          {hasPermission('manageDamage', 'Show') && (
            ...
            >
              <GiBrokenPottery className={`${isOpen ? 'mr-3' : ''} text-md`} />
          ...
          {hasPermission('lotManagement', 'Show') && (
            ...
            >
              <FaCubes className={`${isOpen ? 'mr-3' : ''} text-md`} />
        ...
        <div className="mt-6">
          ...
          <div className="mt-1 space-y-1">
            {hasPermission('category', 'Show') && (
              ...
              >
                <FiLayers className={`${isOpen ? 'mr-3' : ''} text-md`} />
            ...
            {hasPermission('products', 'Show') && (
              ...
              >
                <FiDatabase className={`${isOpen ? 'mr-3' : ''} text-md`} />
        ...
        <div className="mt-6">
          ...
          <div className="mt-1 space-y-1">
            {(userRole === 'admin' || userRole === 'user') && ( // ยังคงใช้ userRole สำหรับเมนูทั่วไป
              ...
              >
                <FiArrowDownCircle className={`${isOpen ? 'mr-3' : ''} text-md`} />
            ...
            {(userRole === 'admin' || userRole === 'user') && ( // ยังคงใช้ userRole สำหรับเมนูทั่วไป
              ...
              >
                <TbTransfer className={`${isOpen ? 'mr-3' : ''} text-md`} />
        ...
        {userRole === 'admin' && (
          <div className="mt-6">
            ...
            <div className="mt-1 space-y-1">
              ...
              >
                <FiUsers className={`${isOpen ? 'mr-3' : ''} text-md`} />
              ...
              >
                <FaBuilding className={`${isOpen ? 'mr-3' : ''} text-md`} />
              ...
              >
                <FiTruck className={`${isOpen ? 'mr-3' : ''} text-md`} />
              ...
              >
                <IoSettingsOutline className={`${isOpen ? 'mr-3' : ''} text-md`} />
